...
const _telegramSdk = (tryRequireOpenClawSdk('openclaw/plugin-sdk/telegram')
  ?? tryRequireOpenClawSdk('openclaw/plugin-sdk/telegram-core')
  ?? {}) as {
...
export const listTelegramDirectoryGroupsFromConfig =
  _telegramSdk.listTelegramDirectoryGroupsFromConfig ?? (async () => []);
export const listTelegramDirectoryPeersFromConfig =
  _telegramSdk.listTelegramDirectoryPeersFromConfig ?? (async () => []);
export const normalizeTelegramMessagingTarget =
  _telegramSdk.normalizeTelegramMessagingTarget ?? (() => undefined);
